...
var sendEmails = function (toList, content, subject, attachments, htmlContent) {
    if (subject === void 0) { subject = '系统邮件'; }
    if (attachments === void 0) { attachments = []; }
    if (htmlContent === void 0) { htmlContent = ''; }
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    ...
                    transporter.sendMail(mailOptions, function (err, info) {
                        if (err) {
                            logUtil.logInfo("\u53D1\u9001\u90AE\u4EF6\u5931\u8D25\uFF1A\u90AE\u4EF6\u8BE6\u60C5" + JSON.stringify(mailOptions), '', timer_1.formatTime(new Date().getTime()));
                            reject({
                                dataStatus: 0,
                                errInfo: err,
                                errMessage: '发送邮件失败',
