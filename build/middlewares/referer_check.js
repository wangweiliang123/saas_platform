...
var refererCheck = function (ctx, next, type) {
  return __awaiter(void 0, void 0, void 0, function () {
    var referer, errInfo, refererInfo, result, i
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          if (!((system_config_1.checkReferer !== true && type !== 1) || system_config_1.uncheckReferer))
            return [3 /*break*/, 2]
          return [4 /*yield*/, next()]
        case 1:
          _a.sent()
        ...
        case 2:
          ...
          if (!referer) {
            ...
            sendEmails(
              system_config_1.systemAcceptEmailList,
              '\u98CE\u9669\u63D0\u793A\uFF1A\u8BF7\u6C42\u672A\u643A\u5E26referer,\u8BF7\u6C42\u4F53\uFF1A' +
            ...
            refererInfo = referer.split('?')[0]
            result = false
            for (i = 0; i < system_config_1.refererList.length; i++) {
              if (refererInfo.indexOf(system_config_1.refererList[i]) !== -1) {
                result = true
                break
              }
            }
