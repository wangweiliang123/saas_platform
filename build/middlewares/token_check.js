...
var tokenCheck = function (ctx, next, type) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 4:
          ...
          sendEmails(
            system_config_1.systemAcceptEmailList,
            '\u98CE\u9669\u63D0\u793A\uFF1AheaderToken\u4E0EsessionToken\u4E0D\u4E00\u81F4,\u8BF7\u6C42\u4F53\uFF1A' +
              JSON.stringify(ctx.request),
            '系统报警',
          )
        ...
        case 6:
          ...
          return [
            4 /*yield*/,
            ctx.util.redis.redisToken.getString(redisTokenKey).then(function (res) {
              if (res.dataStatus === 1) {
                ...
                if (redisToken !== headerToken_1) {
                  ...
                  sendEmails(
                    system_config_1.systemAcceptEmailList,
                    '\u98CE\u9669\u63D0\u793A\uFF1AheaderToken\u4E0EredisToken\u4E0D\u4E00\u81F4,\u8BF7\u6C42\u4F53\uFF1A' +
                      JSON.stringify(ctx.request),
                    '系统报警',
                  )
