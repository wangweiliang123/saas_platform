...
var RedisTool = /** @class */ (function () {
    ...
    RedisTool.prototype.setString = function (key, value, overTime) {
        return __awaiter(this, void 0, void 0, function () {
            var val, k, t, res, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        val = typeof value !== 'string' ? JSON.stringify(value) : value;
                        k = typeof key !== 'string' ? JSON.stringify(key) : key;
                        t = typeof overTime !== 'number' ? (parseInt(overTime) > 0 ? parseInt(overTime) : -1) : overTime;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.redis.set(k, val, t)];
                    case 2:
                        res = _a.sent();
                        console.log(res);
                        if (res) {
                            ...
                            logUtil.logSql(JSON.stringify('Redis设置值失败'), '', timer_1.formatTime(new Date().getTime()));
                            return [2 /*return*/, {
                                    dataStatus: 0,
                                    errInfo: '',
